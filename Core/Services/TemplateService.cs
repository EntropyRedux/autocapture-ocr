...
public class TemplateService
{
    ...
    private List<MetadataTemplate> CreateBuiltInTemplates()
    {
        return new List<MetadataTemplate>
        {
            ...
            // AI Conversation Template (v3.0)
            new MetadataTemplate
            {
                Id = Guid.Parse("00000000-0000-0000-0000-000000000004"),
                Name = "AI Conversation",
                Description = "Metadata for archived AI chat sessions",
                Category = "ChatCapture",
                IsBuiltIn = true,
                Fields = new List<MetadataField>
                {
                    new() { Name = "ai_model", Label = "AI Model", FieldType = MetadataFieldType.Dropdown,
                            DropdownOptions = new List<string> { "Claude", "ChatGPT", "Gemini", "Other" },
                            IsRequired = true, DisplayOrder = 1 },
                    new() { Name = "source_url", Label = "Source URL", FieldType = MetadataFieldType.Text,
                            DisplayOrder = 2, Placeholder = "https://claude.ai/..." },
                    new() { Name = "topic", Label = "Topic", FieldType = MetadataFieldType.Text,
                            DisplayOrder = 3, Placeholder = "Main discussion topic" },
                    new() { Name = "tags", Label = "Tags", FieldType = MetadataFieldType.Text,
                            DisplayOrder = 4, Placeholder = "comma-separated tags" },
                    new() { Name = "notes", Label = "Notes", FieldType = MetadataFieldType.MultilineText,
                            DisplayOrder = 5 }
                }
            }
